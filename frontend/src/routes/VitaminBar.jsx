            ...
            <div className="container  mx-auto py-8 px-4">
                <div className="flex flex-col items-center">
                    ...
                    <div
                        ...
                        <MenuCards title="Ev Yapımı Limonata" image={logo} descriptionTitle="Ev Yapımı Limonata" description="Klasik Ev Yapımı Limonata" price="₺100,00"/>
                        <MenuCards title="Portakal Suyu" image={logo} descriptionTitle="Portakal Suyu" price="₺100,00"/>
                        <MenuCards title="Green Bean Vitamin" image={logo} descriptionTitle="Green Bean Vitamin" description="Bal,Muz,Kivi ve Portakal" price="₺120,00"/>
                    </div>
                </div>
            </div>
            <Footer/>
